...
def test_find_cumulative_marks_i_4():
    results = [
        ...
        ('p101113', 'Jawad Mansoor', None, None, None, None),
        ('p101114', 'Tamleek Ali', 87, None, 19.6)
    ]
    results_out = [('p101111', 'Ali khayam', 213), ('p101112', 'Mudasser Farooq', 98.5), ('p101113', 'Jawad Mansoor', 0), ('p101114', 'Tamleek Ali', 106.6)]
    assert find_cumulative_marks(results) == results_out
...
def test_find_top_student_i_3():
    results = [
        ...
        ('p101114', 'Jawad Mansoor', 87, None, 9.6)
    ]
    results_out = ('p101111', 'Ali khayam')
    assert find_top_student(results) == results_out

def test_find_top_student_i_4():
    results = [
        ('p101111', 'Ali Khayam', 0),
